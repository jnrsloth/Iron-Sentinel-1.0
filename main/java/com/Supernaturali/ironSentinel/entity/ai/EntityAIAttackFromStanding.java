...
public class EntityAIAttackFromStanding extends EntityAIBase
{
    World worldObj;
    ...
    public EntityAIAttackFromStanding(EntityCreature entity, Class classTarget, double speed, boolean longMemory)
    {
        this(entity, longMemory);
        this.classTarget = classTarget;
    }

    public EntityAIAttackFromStanding(EntityCreature entity, boolean longMemory)
    {
